                      ...
                      <Card key={job.id} className="p-6 hover:shadow-lg transition-shadow border-primary/10">
                        <div className="flex items-start justify-between">
                          ...
                          <div className="flex flex-col gap-2 ml-4">
                            <Button 
                              size="sm"
                              onClick={() => console.log('Apply Now clicked for job:', job.title)}
                            >
                              Apply Now
                            ...
                            <Button 
                              variant="outline" 
                              size="sm"
                              onClick={() => console.log('Bookmark clicked for job:', job.title)}
                            >
                            ...
                            <Button 
                              variant="outline" 
                              size="sm"
                              onClick={() => console.log('Share clicked for job:', job.title)}
                            >
                ...
                <div className="mt-16 text-center">
                  <Card className="p-8 bg-gradient-card border-primary/10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      <Button size="lg" onClick={() => console.log('Upload Resume clicked')}>
                        Upload Resume
                        <ArrowRight className="ml-2 h-4 w-4" />
                      </Button>
                      <Button 
                        variant="outline" 
                        size="lg"
                        onClick={() => console.log('Set Job Alerts clicked')}
                      >
                        Set Job Alerts
                      </Button>
                    </div>
